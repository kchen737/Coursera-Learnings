...
def to_mod_list(employee_list):
   ...
   map_employee_list = list()
   for employee in map_employee:
      map_employee_list.append(employee)
...
def generate_usernames(mod_list):
   ...
   list = [department.replace(" ", "_") for department in mod_list]
   return list
   raise NotImplementedError()
...
def map_id_to_initial(employee_list):
   ...
   #dict = {employee["id"]:employee["name"][0] for employee in employee_list}
